...
$nome_empresa = "AGN - Resistências Elétricas";
$emailContato = "agn@agnresistencias.com.br";
$assunto_padrao = "Contato via " . $nome_empresa;
// Parâmetros para Formulário de Contato
$smtp_contato            = "mail.genesisdevstudio.com";
$email_remetente         = "no-reply@genesisdevstudio.com";
$senha_remetente         = "6$X^$C+_@;Ft";

//$smtp_contato            = "mail.clientes.qualitysmi.com.br";
//$email_remetente         = "nao-responda-formulario@clientes.qualitysmi.com.br";
//$senha_remetente         = "i7{!,i)2kPhK";6$X^$C+_@;Ft
...
try {
    ...
    $conteudo .= "<p><strong>Produto</strong>: " . $produto . "</p>";
